  ...
  return (
    <>
      <main className="relative min-h-screen w-full flex items-center justify-center overflow-hidden">
        ...
        {/* Hero Section */}
        <section className="flex flex-col md:flex-row items-center justify-between px-6 md:px-24 gap-12 z-10">
          {/* Text */}
          <div className="max-w-xl text-white">
            ...
            <p className="mt-6 text-base md:text-lg text-sky-100">
          ...
          {/* Image */}
          <div className="relative w-[580px] h-[580px] pt-[100px]">
            <Image
